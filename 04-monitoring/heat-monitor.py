...
def turn_on_ac():
    ...
    os.system(
        'bto_advanced_USBIR_cmd -d `cat ../06-remote-server/ir-codes/temp-24-med-blower-ac.txt`')
    last_ac_status = 1
...
def turn_off_ac():
    ...
    global last_ac_status
    os.system(
        'bto_advanced_USBIR_cmd -d `cat ../06-remote-server/ir-codes/off-ac.txt`')
    last_ac_status = 0
